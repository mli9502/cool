...
/* expression_list represents expressions seperated by ; */
%type <expressions> expression_list
/* comma_expression_list represents expressions seperated by , */
...
| expression '.' OBJECTID '(' ')' { /* expr.ID() */
	$$ = dispatch($1, $3, nil_Expressions());
}
| expression '.' OBJECTID '(' expression comma_expression_list ')' { /* expr.ID(expr[,expr]*) */
...
| expression '@' TYPEID '.' OBJECTID '(' expression comma_expression_list ')' { /* expr@TYPE.ID(expr[,expr]*) */
