...
[dispatch_class::code]: local_var_cnt: 0
...
[let_class::code]: identifier: x
	sw	$a0 4($fp)
In update_store...
store_rtn is null
[dispatch_class::code]
[dispatch_class::code]: method_name: f
[dispatch_class::code]: local_var_cnt: 0
...
[assign_class]::code
	la	$a0 int_const1
In update_store...
[assign_class]::code: after look up variable: x
[assign_class]::code: after look up ACC.
In update_store...
	sw	$a0 4($fp)
	sw	$a0 8($sp)
[assign_class]::code
